...
public class MatchMaker
{
	...
	private LinkedBlockingQueue<Player> playerQ;
	LinkedList<Player> players;
	HashMap<Player, String> rematchMap;
		
	MatchMaker(int startingPlayers)
	{
		playersReady = 0;
	...
	public synchronized void roundReady(Player p, int score)
	{
		playersReady++;
		if (score != 1)
		{
