...
public class Winner3 implements Callable<String>
{
	...
	public Winner3(LinkedList<Player3> players, int numPlayers)
	{
	...
	public String call() 
	{
		Player3 currentPlayer; // player whose score is being compared with minScore
		LinkedList<Player3> losers = new LinkedList<>(); // list of players with minScore
		...
		System.out.println(getTimeStamp() + "GAME OVER\n");
